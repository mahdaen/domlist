define({ "api": [
  ...
  },
  {
    ...
    "group": "2__Core",
    "type": "attr",
    "url": "DOMList.attr(name,value,nodata);",
    "title": ".attr()",
    "name": "Attr",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "nodata",
            "description": "<p>To get attribute as is without converting the result.</p> "
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "group": "8__CSS",
    "type": "ratio",
    "url": "DOMList.ratio(ratio,reverse);",
    "title": ".ratio()",
    "name": "ratio",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "ratio",
            "description": "<p>String ratio. e.g 16:9</p> "
          },
          {
            "group": "Parameter",
            "type": "boolean",
            "optional": false,
            "field": "reverse",
            "description": "<p>If reserved, then ratio count is width by height instead of height by width.</p> "
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "group": "A__DOMAjax",
    "type": "loadURL",
    "url": "DOMList.loadURL(url,callback);",
    "title": ".loadURL()",
    "name": "loadURL",
    "description": "<p>Set content of selected elements by loading contents from URL.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": true,
            "field": "callback",
            "description": "<p>Function that will be called when content loaded or error occurs.</p> "
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "group": "B__DOMNotice",
    "type": "notification",
    "url": "DOMList.notification(title,options)",
    "title": "DOMList.notification()",
    "name": "notification",
    "description": "<p>Create new or manage HTML5 Notification API. With DOMNotice, you can simply show new notification or use existing notification object to show notification. DOMNotice will request permission when first time created.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "filename": "tags/v2.5.0.js",
    "groupTitle": "B__DOMNotice"
  },
  {
    "version": "2.5.0",
    "group": "B__DOMNotice",
    "type": "onclick",
    "url": "DOMNotice.onclick(handler)",
    "title": ".onclick()",
    "name": "onclick",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "handler",
            "description": "<p>Function to handle event. Hanlder will become DOMNotice object and get event as param.</p> "
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "group": "B__DOMNotice",
    "type": "show",
    "url": "DOMNotice.show(title,options)",
    "title": ".show()",
    "name": "show",
